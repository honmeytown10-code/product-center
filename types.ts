...
export const COMMON_FIELD_CHILD_CONFIG_LIBRARY: Record<string, FieldChildOption[]> = {
  ...
  a_addons: [
    { id: 'a_rule_scope', label: '购买限制范围', isDefaultSelected: true, description: '限制所有加料购买总量，或按加料类型分别限制购买数。' },
    { id: 'a_rule_unlimited', label: '数量不限', isDefaultSelected: true, description: '加料购买数量不限。' },
    { id: 'a_rule_limit', label: '起购/限购', isDefaultSelected: true, description: '控制一旦购买时的最少和最多购买数量。' },
    { id: 'a_rule_required', label: '必选设置', isDefaultSelected: true, description: '保留点餐时必选规则，并支持在起购/限购规则下单独设置是否必选。' },
