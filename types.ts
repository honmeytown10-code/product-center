...
export const COMMON_FIELD_CHILD_CONFIG_LIBRARY: Record<string, FieldChildOption[]> = {
  ...
  a_addons: [
    { id: 'a_rule_scope', label: '加料配置', isDefaultSelected: true, description: '限制所有加料购买总量，或按加料类型分别限制购买数；默认限制所有加料购买总量。' },
    { id: 'a_rule_unlimited', label: '点餐时数量不限', isDefaultSelected: true, description: '顾客点餐时加料购买数量不限。' },
    { id: 'a_rule_limit', label: '点餐时起购限购数', isDefaultSelected: true, description: '控制顾客购买加料时的最少和最多购买数量。' },
    { id: 'a_rule_required', label: '点餐时必选', isDefaultSelected: true, description: '与数量不限、起购限购互斥，要求顾客点餐时必须选择加料。' },
    ...
    { id: 'a_addon_limit', label: '单品限购', isDefaultSelected: true, description: '当前商品内单个加料的最大购买数量。' },
    { id: 'a_addon_price', label: '加料价格', isDefaultSelected: true, description: '加料商品价格。' },
    { id: 'a_addon_spec_price', label: '规格价格', isDefaultSelected: true, description: '加料商品规格价格。' },
